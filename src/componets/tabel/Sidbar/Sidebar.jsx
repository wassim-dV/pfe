...
>
  ...
  >
    ...
    <ListItem
      ...
      sx={{ color: "#1976d2" }}
    >
      <ListItemButton onClick={handleNavigation2}>
        <ListItemIcon
          sx={{
            minWidth: 0,
            mr: open ? 3 : "auto",
    ...
    <ListItem
      ...
      sx={{ color: "#1976d2" }}
    >
      <ListItemButton onClick={handleNavigation3}>
        <ListItemIcon
          sx={{
            minWidth: 0,
            mr: open ? 3 : "auto",
    ...
    <ListItem
      ...
      sx={{ color: "#1976d2" }}
    >
      <ListItemButton onClick={handleNavigation6}>
        <ListItemIcon
            sx={{
              minWidth: 0,
              mr: open ? 3 : "auto",
    ...
    <ListItem
      ...
      sx={{ color: "#1976d2" }}
    >
      <ListItemButton onClick={handleNavigation5}>
        <ListItemIcon
         sx={{
          minWidth: 0,
          mr: open ? 3 : "auto",
    ...
    <ListItem
      ...
      sx={{ color: "#1976d2" }}
    >
      <ListItemButton onClick={handleNavigation7}>
        <ListItemIcon
         sx={{
          minWidth: 0,
          mr: open ? 3 : "auto",
