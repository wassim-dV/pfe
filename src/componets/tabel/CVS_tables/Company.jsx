...
const initialRows = [
  { id: 1, Name: 'John', LastName: 'Doe', company_name: '2000-12-19', Email: 'john.doe@example.com' , Role: "Teacher" },
  { id: 2, Name: 'Jane', LastName: 'Smith', company_name: '1995-08-14', Email: 'jane.smith@example.com', Role: "Student" },
  { id: 1, Name: 'John', LastName: 'Doe', company_name: '2000-12-19', Email: 'john.doe@example.com' , Role: "Admistator" },
  { id: 2, Name: 'Jane', LastName: 'Smith', company_name: '1995-08-14', Email: 'jane.smith@example.com', Role: "Teacher" },
  { id: 1, Name: 'John', LastName: 'Doe', company_name: '2000-12-19', Email: 'john.doe@example.com' , Role: "Teacher" },
  { id: 2, Name: 'Jane', LastName: 'Smith', company_name: '1995-08-14', Email: 'jane.smith@example.com', Role: "Teacher" },
  { id: 1, Name: 'John', LastName: 'Doe', company_name: '2000-12-19', Email: 'john.doe@example.com' , Role: "Teacher" },
  { id: 2, Name: 'Jane', LastName: 'Smith', company_name: '1995-08-14', Email: 'jane.smith@example.com', Role: "Teacher" },
...
export default function Teacher() {
  ...
  const [editData, setEditData] = useState({ id: '', Name: '', LastName: '', company_name: '', Email: '' });
  const [newData, setNewData] = useState({ Name: '', LastName: '', company_name: '', Email: '' });
  ...
  const handleAddClick = () => {
    setNewData({ Name: '', LastName: '', company_name: '', Email: '' });
  ...
  const columns = [
    ...
    { field: 'Name', headerName: 'First Name', width: 170, align: 'center', headerAlign: 'center' },
    { field: 'LastName', headerName: 'Last Name', width: 190, align: 'center', headerAlign: 'center' },
    { field: 'Email', headerName: 'Email', width: 290, align: 'center', headerAlign: 'center' },

    { field: 'company_name', headerName: ' Company Name', width: 170, align: 'center', headerAlign: 'center' },
    {
      width:8,
